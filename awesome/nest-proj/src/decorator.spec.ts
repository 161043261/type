...
// declare type ClassDecorator = (target: Function) => Function | void;
// declare type PropertyDecorator = (target: object, propertyKey: string | symbol) => void;
// declare type MethodDecorator = (target: object, propertyKey: string | symbol, descriptor: PropertyDescriptor) => PropertyDescriptor | void;
// declare type ParameterDecorator = (target: object, propertyKey: string | symbol | undefined, parameterIndex: number) => void;

describe('DecoratorTest' /** TestSuite */, () => {
  // 类装饰器
  //! jest DecoratorTest.testClassDecorator decorator.spec.ts
  it('testClassDecorator' /** testCase */, () => {
    // target: 类, 类是构造函数的语法糖
  ...
  // 属性装饰器
  //! jest DecoratorTest.testPropDecorator decorator.spec.ts
  it('testPropDecorator', () => {
    //! target: 原型对象
    //! propertyKey: 属性名
  ...
  // 方法装饰器
  //! jest DecoratorTest.testMethodDecorator decorator.spec.ts
  it('testMethodDecorator', () => {
    //! target: 原型对象
    //! propertyKey: 方法名
  ...
  // 参数装饰器
  //! jest DecoratorTest.testParameterDecorator decorator.spec.ts
  it('testParameterDecorator', () => {
    // target: 原型对象
    // propertyKey: 方法名
    // parameterIndex: 参数索引
