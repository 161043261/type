...
test(
  "Test_Promise2",
  async () => {
    let p1 = new Promise(function (_resolve, reject) {
      setTimeout(() => {
        console.log("second");
    ...
    let p2 = new Promise(function (resolve, _reject) {
      setTimeout(() => {
        console.log("first");
...
test("Test_Promise3", () => {
  ...
  // 等价于
  let p2 = new Promise(function (_resolve, reject) {
...
test("Test_Promise_Generator", () => {
  let genFunc = function* () {
    try {
      let value /* : string */ = yield new Promise(function (resolve, _reject) {
        resolve("foo");
      });
...
test("Test_Promise6", () => {
  Promise.resolve().then((_value) => console.log("1st")); // 异步
  Promise.resolve().then((_value) => (async () => console.log("2nd"))()); // 异步
  console.log("3rd");
  ...
  new Promise((resolve, _reject) => resolve(console.log("7th"))); // 同步
  new Promise((resolve, _reject) =>
    resolve((async () => console.log("8th"))()),
  ); // 同步
  console.log("9th");
});
